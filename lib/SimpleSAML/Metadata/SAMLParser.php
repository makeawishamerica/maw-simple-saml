...
class SAMLParser
{
     ...
     */
    public function getMetadata1xSP() : ?array
    {
     ...
     */
    public function getMetadata1xIdP() : ?array
    {
        $ret = $this->getMetadataCommon();
     ...
     */
    public function validateFingerprint(string $fingerprint, string $algorithm) : bool
    {
